                ...
                <div class="flex h-16 justify-between">
                    <div class="flex">
                        ...
                        <div class="flex shrink-0 items-center">
                            <Link href="/">
                                <svg class="block h-9 w-auto fill-current text-gray-800" viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <Link :href="route('posts.index')"
                                  class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900 transition duration-150 ease-in-out focus:border-indigo-700 focus:outline-none"
                                  :class="{ 'border-b-2 border-indigo-400': route().current('posts.index') }">Posts
                            </Link>
                            <Link :href="route('about')"
                                  class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900 transition duration-150 ease-in-out focus:border-indigo-700 focus:outline-none"
                                  :class="{ 'border-b-2 border-indigo-400': route().current('about') }">About
                            </Link>
                        </div>
                    </div>
